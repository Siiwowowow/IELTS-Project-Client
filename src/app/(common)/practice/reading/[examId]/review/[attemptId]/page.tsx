  ...
  return (
    <div className="space-y-6 max-w-3xl mx-auto pb-12 py-6 px-4">
      ...
      <div className="flex flex-col sm:flex-row gap-3 pt-2">
        <Link
          href="/practice/reading"
          className="flex-1 flex items-center justify-center gap-2 py-3 bg-primary hover:bg-primary/90 text-white font-semibold rounded-2xl transition-all shadow-md shadow-primary/20 text-sm cursor-pointer"
        >
          Practice Another Exam
        </Link>
        <Link
          href={`/practice/reading/${examId}`}
          className="flex-1 flex items-center justify-center gap-2 py-3 bg-white border border-gray-200 hover:border-primary/40 text-gray-700 hover:text-primary font-semibold rounded-2xl transition-all text-sm cursor-pointer"
        >
          Retry This Exam
        </Link>
      </div>
