...
function TeacherDashboardContent() {
  ...
  const handleAddQuestion = (e: React.FormEvent) => {
    ...
    if (selectedTypeDetails.type === "MULTIPLE_CHOICE_MULTIPLE") {
      ...
      setCompiledQuestions([...compiledQuestions, ...generatedQs].sort((a, b) => a.questionNumber - b.questionNumber));
                      ...
                      <button
                        ...
                        onClick={() => {
                          ...
                          if (type.code === "R-MINF") {
                            ...
                            if (!questionInstruction.trim() || questionInstruction === "||||||" || questionInstruction === "|||") {
                              setQuestionInstruction("|||Complete the sentences below.|||Choose NO MORE THAN TWO WORDS from the passage for each answer.|||");
                            }
                          }
                        }}
                          ...
                          <div className="space-y-2 py-1">
                            <div className="flex flex-wrap gap-x-4 gap-y-2">
                              {["A", "B", "C", "D", "E", "F", "G"].map((letter) => {
                                ...
                                return (
                                  <label key={letter} className="flex items-center gap-1.5 text-xs text-black font-semibold cursor-pointer">
                                    <input 
                                      type="checkbox" 
                                      checked={isChecked} 
